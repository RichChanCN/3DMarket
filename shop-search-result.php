...
if($keyword != "" or $keyword != null){
    ...
    global $related_item;
    //验证内容是否与数据库的记录吻合。
    $sql = "SELECT * FROM item WHERE (name LIKE '%$keyword%') OR (use_case LIKE '%$keyword%') OR (type LIKE '%$keyword%') OR (brand LIKE '%$keyword%') OR (style LIKE '%$keyword%')";
        ...
        <div class="row margin-bottom-40">
            ...
            <div class="col-md-9 col-sm-7">
                <div class="content-search margin-bottom-20">
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo "<h1>搜索<em>".$keyword."</em>的结果</h1>" ?>
                        </div>
                        <div class="col-md-6">
                            <form action="shop-search-result.php" method="get" onsubmit="return searchCheck(this)">
                                <div class="input-group">
                                    <input type="text" placeholder="重新搜索" name="keyword" id="keyword"  class="form-control">
                                    <span class="input-group-btn">
                        <button class="btn btn-primary" type="submit">搜索</button>
                      </span>
                                </div>
                    ...
                    <div class="col-md-8 col-sm-8">
                        <ul class="pagination pull-right">
                            ...
                            if($page>1)
                                ...
                                echo "<li><a href=\"shop-product-list.php?type=".$type."\">&laquo;</a></li>";
                            ...
                            echo "<li><a href=\"shop-product-list.php?type=".$type."&page=".$x."\">&raquo;</a></li>"
                            ?>
                        </ul>
                    </div>
                </div>
