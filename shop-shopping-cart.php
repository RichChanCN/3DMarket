        ...
        <div class="top-cart-block">
            <div class="top-cart-info">
                ...
                if ($_SESSION['user_name'] == "" || $_SESSION['user_name'] == null){
                    ...
                    $order_sql = "SELECT * FROM shopping_order WHERE (user_id='$_SESSION[user_id]')";
                    ...
                    if($order_counts>0){
                        ...
                        while($order_row = $order_result->fetch_assoc()) {
                            ...
                            if ($item_result->num_rows > 0) {
                                ...
                                $my_orders[$count] = new Order_Plus($order_row["id"],$order_row["item_id"],$item_row["name"],$item_row["price"],$order_row["amount"],$item_row["discount"],$order_row["style"],$item_row["brand"],$item_row["materials"],$order_row["is_paid"]);
                                $count += 1;
                            }
                        }
                    }
                    ...
                    <div class="goods-data clearfix">
                        <div class="table-wrapper-responsive">
                            <table summary="Shopping cart">
                                <?php
                                if($order_counts<1)
                                    echo "<a href=\"shop-index.php\">购物车里什么也没有，快去购物吧！</a>";
                                else
                                {
                                    echo "
                                    <tr>
                                        ...
                                        <th class=\"goods-page-ref-no\">地址</th>
                                        <th class=\"goods-page-quantity\">数量</th>
                                        <th class=\"goods-page-price\">单价</th>
                                        <th class=\"goods-page-total\" colspan=\"2\">总和</th>
                                    </tr>
                                    ";
                                    foreach ($my_orders as $temp) {
                                        if ($temp->is_paid == 0){
                                    ...
                                    <tr>
                                        <td class=\"goods-page-image\">
                                            <a href=\"shop-item.php?id=".$temp->item_id."\"><img src=\"assets/pages/img/items/".$temp->item_id.".jpg\" alt=\"Berry Lace Dress\"></a>
                                        </td>
                                        <td class=\"goods-page-description\">
                                            <h3><a href=\"shop-item.php?id=".$temp->item_id."\">".$temp->name."</a></h3>
                                            <p><strong>".$temp->brand."</strong> - 搭配：".$temp->style."</p>
                                            <em>".$temp->materials."</em>
                                        </td>
                                        ...
                                        <td class=\"goods-page-quantity\">
                                            <div class=\"product-quantity\">
                                             <ul class=\"pagination\">
                                                <li><a>".$temp->amount."</a></li>
                                             </ul>
                                            </div>
                                        </td>
                                        <td class=\"goods-page-price\">
                                            <strong><span>￥</span>".$temp->getUnitPrice()."</strong>
                                        </td>
                                        <td class=\"goods-page-total\">
                                            <strong><span>￥</span>".$temp->getOrderPrice()."</strong>
                                        </td>
                                        <td class=\"del-goods-col\">
                                            <a class=\"del-goods\" href=\"javascript:deleteOrder(".$temp->id.");\">&nbsp;</a>
                                        </td>
                                    </tr>
                                    ";
                                        }
                        ...
                        <div class="shopping-total">
                            <ul>
                                <li>
                                    <em>商品总价</em>
                                    <?php echo "<strong class=\"price\"><span>￥</span>$order_price</strong>"; ?>
                                </li>
                                <li>
                                    <em>运费</em>
                                    <strong class="price"><span>￥</span>50</strong>
                                </li>
                                <li class="shopping-total-price">
                                    <em>支付总额</em>
                                    <?php echo "<strong class=\"price\"><span>￥</span>".($order_price+50)."</strong>"; ?>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <a class="btn btn-default" href="shop-index.php">继续购物 <i class="fa fa-shopping-cart"></i></a>
                    <?php
                    if ($order_counts>0)
                        echo "<a href=\"#QRcode\" class=\"btn btn-primary fancybox-button\" onclick=\"payMoney(".($order_price+50).")\">立即支付 <i class=\"fa fa-check\"></i></a>";
                    ?>
                </div>
            </div>
            <!-- END CONTENT -->
                    ...
                    <div class="goods-data clearfix">
                        <div class="table-wrapper-responsive">
                            <table summary="Shopping cart">
                                <?php
                                if($order_counts<1)
                                    echo "<p>你还没有买过东西呢，快去支付或者<a href=\"shop-index.php\">购物</a>吧！</p>";
                                else
                                {
                                    echo "
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class=\"del-goods-col\">
                                            <a href=\"shop-item.php?id=".$temp->item_id."#WriteReview\">去写评论</a>
                                        </td>
                                    </tr>
                                    ";
                                        }
...
<!-- BEGIN qrcode view of a product -->

<div id="QRcode" style="display: none; width:200px; height:200px">
</div>
<!-- END qrcode view of a product -->
...
<!-- 二维码生成 -->
<script src="assets/corporate/scripts/qrcode.min.js" type="text/javascript"></script>
<script src="assets/corporate/scripts/qrcode.js" type="text/javascript"></script>
